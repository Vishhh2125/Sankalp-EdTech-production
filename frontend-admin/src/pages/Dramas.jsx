    ...
    <div className="page-enter">
      ...
      <div className="search-row">
        <div className="search-wrap">
          ...
          <input className="input" style={{ paddingLeft: 32 }} placeholder="Search course, tags…" value={q} onChange={e => setQ(e.target.value)} />
        </div>
                          ...
                          {d.episodes.map((ep, idx) => (
                            ...
                            >
                              ...
                              <div style={{ minWidth: 80, flexShrink: 0 }}>
                                <span className={`badge ${ep.status === 'published' ? 'badge-green' :
